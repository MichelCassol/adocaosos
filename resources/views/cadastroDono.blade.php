        ...
        <div class="card-box">
            ...
            <form>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label name="comboEstado" for="comboEstado" class="col-form-label">Estado</label>
