            ...
            <div class="slimscroll-menu">
                ...
                <div id="sidebar-menu">
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li><a href="javascript: void(0);"><i class="mdi mdi-atom"></i> <span>UI Elements </span><span
                        ...
                        <li><a href="javascript: void(0);"><i class="mdi mdi-email-outline"></i><span> Email
                        ...
                        <li><a href="calendar.html"><i class="mdi mdi-calendar"></i> <span>Calendar</span></a></li>
                        <li><a href="javascript: void(0);"><i class="mdi mdi-chart-donut-variant"></i><span> Charts
                                </span><span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="javascript: void(0);"><i class="mdi mdi-file-document-box"></i><span
                                    class="badge badge-danger float-right">6</span> <span>Forms</span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="javascript: void(0);"><i class="mdi mdi-filter-variant"></i> <span>Tables
                                </span><span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="javascript: void(0);"><i class="mdi mdi-buffer"></i><span> Authentication
                                </span><span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="javascript:void(0);"><i class="mdi mdi-google-pages"></i> <span>Pages </span><span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
